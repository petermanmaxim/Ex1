    ...
    <script>
        $(document).ready(function () {
            $("#order").on("submit", function (e) {
                ...
                var data = "place-order&name=" + encodeURIComponent(name) + "&contact=" + encodeURIComponent(contact) + "&address=" + encodeURIComponent(address);
                $.ajax({
                    url: "src/request.php",
                    type: "post",
                    data: data,
...
<div>
    ...
    <table id="order-summary">
        ...
        <tr>
            <td id="gt-container" colspan="5">Grand Total: <span
                        id="grand-total"><?= number_format($grandTotal, 2) ?></span></td>
        </tr>
    </table>
