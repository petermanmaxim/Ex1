...
class Db
{
    ...
    // place order
    public function placeOrder($name, $contact, $address, $order)
    {
        $timestamp = date("YmdHis");
        $query = "insert into orders (time_placed, name, contact_number, address) value ('" . $timestamp . "', '" . $name . "', '" . $contact . "', '" . $address . "')";
