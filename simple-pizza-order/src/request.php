...
if (isset($_POST["add"])) {
    ...
    if (isset($_POST['name']) && $_POST['name'] && $_POST['address'] != "" && isset($_POST['contact']) && $_POST['contact'] && $_POST['address'] != "") {
        require_once("session.php");
        require_once("db.php");
        ...
        $or = $db->placeOrder($_POST['name'], $_POST['contact'], $_POST['address'], $sess->getCart());
        echo "success:+:" . $or;
        //$sess->endSession();
